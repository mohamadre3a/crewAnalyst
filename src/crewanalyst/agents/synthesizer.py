...
synthesizer_agent = Agent(
    ...
    goal=(
        ...
        "Identify the 3-5 key findings that a business stakeholder should take away from this dataset,"
        "and articulate them in a way that is easy to understand and act on. "
        "Also provide an honest assessment of any limitations or uncertainties in the data that might impact decision-making."
    ),
    backstory=(
        "You are a brilliant data storyteller with a knack for synthesis."
        "You can take complex, technical analysis and distill it down into the few insights that really matter. "
